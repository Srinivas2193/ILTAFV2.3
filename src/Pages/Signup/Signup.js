...
//           {/* <!-- component --> */}
//           <div className="flex flex-col items-center justify-center mt-44 sm:py-12">
...
//                   <div>
//                     <h1 className="text-3xl font-semibold text-center text-orange-500 bg-blue-500 border-2 border-blue-500 rounded-md w-max">
//                       Signup
//                     </h1>
//                   </div>
...
export default function Signup(){
    ...
    return(
      ...
      <div>
        ...
        {/* //Header section */}
        <div className='container p-24 pt-24 w-[1220px] bg-gradient-to-r from-orange-300 to-blue-300'>
