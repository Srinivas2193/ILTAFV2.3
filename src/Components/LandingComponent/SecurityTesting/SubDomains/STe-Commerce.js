...
const STeCommerce = () => {
  ...
  return (
    <>
          <Bredcrumb to1={`/home/security-testing`} to2={`/home/security-testing/e-commerce`} prev={`Security Testing`} current={`e-Commerce`} />

    <div className="flex flex-row flex-wrap justify-center px-5 mb-16 mt-14 gap-36 ">
        {STeCommerce.map((res, i) => {
          return (
            <>
