...
const FAFinancialAndAnalytical = () => {
  ...
  return (
    <>
                <Bredcrumb to1={`/home/functional-automation`} to2={`/home/functional-automation/financial-analytical`} prev={`Functional And Automation testing`} current={`Financial And Analytical`} />
    
    <div className="flex flex-row flex-wrap justify-center px-5 mb-16 mt-14 gap-36 ">
        {FAFinancialAndAnalytical.map((res, i) => {
          return (
            <>
...
export default FAFinancialAndAnalytical