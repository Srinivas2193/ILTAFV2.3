...
const FABlockChain = () => {
  ...
  return (
    <>
                <Bredcrumb to1={`/home/functional-automation`} to2={`/home/functional-automation/blockchain`} prev={`Functional And Automation testing`} current={`BlockChain`} />

    <div className="flex flex-row flex-wrap justify-center px-5 mb-16 mt-14 gap-36 ">
        {FABlockChain.map((res, i) => {
          return (
            <>
