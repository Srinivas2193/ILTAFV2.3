...
const FAAnalytics = () => {
  ...
  return (
    <>
                <Bredcrumb to1={`/home/functional-automation`} to2={`/home/functional-automation/analytics`} prev={`Functional And Automation testing`} current={`Analytics`} />

    <div className="flex flex-row flex-wrap justify-center px-5 mb-16 mt-14 gap-36 ">
        {FAAnalytics.map((res, i) => {
          return (
            <>
