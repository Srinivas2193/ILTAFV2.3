...
const FAEcommerce = () => {
  ...
  return (
    <>
                <Bredcrumb to1={`/home/functional-automation`} to2={`/home/functional-automation/e-commerce`} prev={`Functional And Automation testing`} current={`e-Commerce`} />

    <div className="flex flex-row flex-wrap justify-center px-5 mb-16 mt-14 gap-36 ">
        {FAEcommerce.map((res, i) => {
          return (
            <>
