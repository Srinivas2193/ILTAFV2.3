...
const FAFintech = () => {
  ...
  return (
    <>
                    <Bredcrumb to1={`/home/functional-automation`} to2={`/home/functional-automation/fintech`} prev={`Functional And Automation testing`} current={`Fintech`} />
