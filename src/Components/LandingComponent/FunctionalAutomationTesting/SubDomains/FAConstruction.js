...
const FAConstruction = () => {
  ...
  return (
    <>
                <Bredcrumb to1={`/home/functional-automation`} to2={`/home/functional-automation/construction`} prev={`Functional And Automation testing`} current={`Construction`} />

    <div className="flex flex-row flex-wrap justify-center px-5 mb-16 mt-14 gap-36 ">
        {FAConstruction.map((res, i) => {
          return (
            <>
