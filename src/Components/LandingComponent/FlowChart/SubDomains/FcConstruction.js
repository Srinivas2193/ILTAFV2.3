...
const FcConstruction = () => {
  ...
  return (
    <>
            <Bredcrumb to1={`/home/flow-chart`} to2={`/home/flow-chart/construction`} prev={`Flow Chart`} current={`Construction`} />

    <div className="flex flex-row flex-wrap justify-center px-5 mb-16 mt-14 gap-36 ">
        {FcConstruction.map((res, i) => {
          return (
            <>
