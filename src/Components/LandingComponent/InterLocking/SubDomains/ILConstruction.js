...
const ILConstruction = () => {
  ...
  return (
    <>
                    <Bredcrumb to1={`/home/inter-locking`} to2={`/home/inter-locking/construction`} prev={`InterLocking`} current={`Construction`} />

    {/* <div className="flex flex-row flex-wrap justify-center px-5 mb-16 mt-14 gap-36 ">
        {ILConstruction.map((res, i) => {
          return (
            <>
