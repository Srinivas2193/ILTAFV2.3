...
const ILBlockChain = () => {
  ...
  return (
    <>
                    <Bredcrumb to1={`/home/inter-locking`} to2={`/home/inter-locking/blockchain`} prev={`InterLocking`} current={`BlockChain`} />

    {/* <div className="flex flex-row flex-wrap justify-center px-5 mb-16 mt-14 gap-36 ">
        {ILBlockChain.map((res, i) => {
          return (
            <>
