...
const ILEcommerce = () => {
  ...
  return (
    <>
                    <Bredcrumb to1={`/home/inter-locking`} to2={`/home/inter-locking/e-commerce`} prev={`InterLocking`} current={`e-Commerce`} />

    {/* <div className="flex flex-row flex-wrap justify-center px-5 mb-16 mt-14 gap-36 ">
        {ILEcommerce.map((res, i) => {
          return (
            <>
